...
# Build the project
RUN wget https://github.com/vpubchain/Vpub/releases/download/v1.2.0.0/vpub-1.1.0-x86_64-linux-gnu.tar.gz -O vpub-1.1.0.tar.gz
...
WORKDIR /vpub-1.1.0/bin
CMD ["/vpub-1.1.0/bin/vpubd"]
