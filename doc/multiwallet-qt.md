...
In order to support loading of multiple wallets in vpub-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vpub.cpp.
...
Changes to vpub.cpp
----------------------
vpub.cpp is the entry point into vpub-qt, and as such, will require some minor modifications to provide hooks for
