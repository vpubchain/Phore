...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/vpubchain/Vpub/blob/master/doc/translation_process.md#synchronising-translations).
...
### Vpub maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Vpub Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/vpubchain/Vpub/releases/new) with a link to the archived release notes.
