...
*Setup instructions for a Gitian build of Vpub Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the Vpub
...
- [Building Vpub Core](#building-vpub-core)
...
To build Vpub Core (for Linux, OS X and Windows) just follow the steps under 'perform
