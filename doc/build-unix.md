...
Note
---------------------
Always use absolute paths to configure and compile vpub and the dependencies,
...
If you want to build Vpub-Qt, make sure that the required packages for Qt development
...
Notes
-----
The release is built with GCC and then "strip vpubd" to strip the debug
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, vpub should be built with a non-executable stack
