...
* WebSocket: [https://github.com/vpubchain/insight-api-vpub#web-socket-api](https://github.com/vpubchain/insight-api-vpub#web-socket-api) 
* API: [https://github.com/vpubchain/insight-api-vpub#swifttx-transactions](https://github.com/vpubchain/insight-api-vpub#swifttx-transactions) 
...
By default, the Vpub Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vpub Core daemon:
