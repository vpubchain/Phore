...
The Vpub Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vpub Core project, and is not to be
confused with overall Vpub Network Protocol consensus changes.
