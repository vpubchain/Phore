...
def initialize_chain(test_dir, num_nodes):
    ...
    if create_cache:
        ...
        for i in range(MAX_NODES):
            ...
            args = [ os.getenv("VPUBD", "phored"), "-server", "-keypool=1", "-datadir="+datadir, "-discover=0" ]
            if i > 0:
...
def stop_node(node, i):
    ...
    phored_processes[i].wait(timeout=VPUBD_PROC_WAIT_TIMEOUT)
...
def wait_phoreds():
    ...
    for phored in phored_processes.values():
        phored.wait(timeout=VPUBD_PROC_WAIT_TIMEOUT)
