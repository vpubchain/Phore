 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Vpub (http://www.vpub.io),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Vpub Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";

        if (mapArgs.count("-version")) {
            strUsage += LicenseInfo();
        } else {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  vpubd [options]                     " + _("Start Vpub Core Daemon") + "\n";
