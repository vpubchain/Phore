...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VP:
            return QString("VP");
        case mVP:
            return QString("Milli-VP (1 / 1" THIN_SP_UTF8 "000)");
        case uVP:
            return QString("Micro-VP (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VP:
            return QString("TestVPs");
        case mVP:
            return QString("Milli-TestVP (1 / 1" THIN_SP_UTF8 "000)");
        case uVP:
            return QString("Micro-TestVP (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
