...
<context>
    ...
    <message>
        ...
        <translation>Phore will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your VPs from being stolen by malware infecting your computer.</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Phore Alert" admin@foo.com
        ...
        <translation>To use vpubd, or the -server option to phore-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=phorerpc
rpcpassword=%s
