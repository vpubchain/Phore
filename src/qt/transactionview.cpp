 ...
 */
    ...
    typeWidget->addItem(tr("Received Vp from zVp"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVp"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVp));
