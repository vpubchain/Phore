...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"rawtransactions", "getrawtransaction", &getrawtransaction, true, false, false},
         {"rawtransactions", "gettransactioninfo", &gettransactioninfo, true, false, false},  //add by lkz
        ...
        /* Vpub features */
        {"vpub", "masternode", &masternode, true, true, false},
        {"vpub", "listmasternodes", &listmasternodes, true, true, false},
        {"vpub", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"vpub", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"vpub", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"vpub", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vpub", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vpub", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vpub", "masternodedebug", &masternodedebug, true, true, false},
        {"vpub", "startmasternode", &startmasternode, true, true, false},
        {"vpub", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vpub", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vpub", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vpub", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vpub", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vpub", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vpub", "mnbudget", &mnbudget, true, true, false},
        {"vpub", "preparebudget", &preparebudget, true, true, false},
        {"vpub", "submitbudget", &submitbudget, true, true, false},
        {"vpub", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vpub", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vpub", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vpub", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vpub", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vpub", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vpub", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vpub", "checkbudgets", &checkbudgets, true, true, false},
        {"vpub", "mnsync", &mnsync, true, true, false},
        {"vpub", "spork", &spork, true, true, false},
        {"vpub", "getpoolinfo", &getpoolinfo, true, true, false},
        {"vpub", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> vpub-cli " + methodname + " " + args + "\n";
}
