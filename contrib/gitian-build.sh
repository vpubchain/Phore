...
VERSION=
commit=false
url=https://github.com/vpubchain/phore
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the phore, gitian-builder, gitian.sigs, and vpub-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/vpubchain/phore
