...
This means one can have an always-on vpubd instance running, and another local vpubd/vpub-qt instance which connects to this node and receives blocks from it.
